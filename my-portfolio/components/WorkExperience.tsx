...
const WorkExperience = (props: Props) => {
  return (
    <div
      id="experience"
      className="w-full h-screen overflow-x-hidden grid items-center snap-start"
    >
      <div>
        <h1 className="mb-10 text-5xl md:text-6xl text-left lg:text-center font-bold  bg-gradient-to-r from-[--color-theme] to-green-400 bg-clip-text text-transparent">
          Work Experience
        </h1>
        <Slide duration={1000}>
