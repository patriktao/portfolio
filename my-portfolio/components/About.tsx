        ...
        <div className="lg:col-span-2 lg:col-start-1 lg:row-start-1 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
          <div className="lg:pr-4">
            <div className="lg:max-w-lg">
              <p className="text-base font-semibold leading-7 text-[--color-theme]">
              ...
              <p className="mt-6 mb-6 text-xl leading-8 dark:text-gray-300">
                I am a fourth year student in M.Sc.Eng in Computer Science (Joint B.Sc and M.Sc) with a specialisation in Software Engineering at Lund University, and have been living in Lund since 2019. I love making my own music, doing sports, travelling across Asia, and enjoy spending quality time with my friends.
              </p>
