...
const Header = (props: Props) => {
  ...
  return (
    <div
      id="home"
      className="w-full min-h-screen grid snap-mandatory snap-start"
    >
      <Fade duration={2000}>
        <div className="max-w-[1240px] w-full h-full mx-auto p-2 flex flex-wrap lg:flex-nowrap items-center justify-center mt-4 lg:mt-0 gap-8 lg:gap-0">
